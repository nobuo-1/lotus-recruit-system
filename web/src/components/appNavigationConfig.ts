...
export const APP_NAV_ITEMS: AppNavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "実行状況", href: "/job-boards/runs", icon: LayoutDashboard },
  ...
  },
  {
    ...
    children: [
      ...
      { title: "メッセージ", href: "/form-outreach/messages", icon: MessageSquareText },
      { title: "テンプレート", href: "/form-outreach/templates", icon: Files },
      { title: "送信元設定", href: "/form-outreach/senders", icon: Send },
      { title: "スケジュール", href: "/form-outreach/schedules", icon: FileClock },
      { title: "実行履歴", href: "/form-outreach/runs", icon: LayoutDashboard },
      { title: "全履歴", href: "/form-outreach/runs/all", icon: FileClock },
      { title: "手動送信", href: "/form-outreach/runs/manual", icon: Send },
      { title: "自動化", href: "/form-outreach/automation", icon: Workflow },
      { title: "フィルタ設定", href: "/form-outreach/settings/filters", icon: Settings2 },
      { title: "待機リスト", href: "/form-outreach/waitlist", icon: ListChecks },
    ],
  },
  {
    title: "スカウト運用",
